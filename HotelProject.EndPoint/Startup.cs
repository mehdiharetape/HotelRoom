...
using HotelProject.Application.Services.Facade;
...
namespace HotelProject.EndPoint
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //Facade Pattern
            services.AddScoped<IFacadePattern, FacadePattern>();

            //Get Connection string from appsettings.json
            string con = this.Configuration.GetConnectionString("HotelRoom");
            services.AddEntityFrameworkSqlServer()
                .AddDbContext<DataBaseContext>(options => options.UseSqlServer(con));
